...
format:
  hugo-md:
    output-file: index
    output-ext: md
excerpt: "En un post anterior vimos cómo usar R para [producir textos basados en datos](/blog/redactar_texto/). En este post veremos cómo usar un modelo de lenguaje (LLM) o _IA_ para interpretar datos directamente desde R, pero también usaremos la IA para generar código de R y reutilizarlo. Moraleja: es mejor pedirle código a la IA que pedirle respuestas y arriesgarte a errores o alucinaciones!"
---
