...
Un problema común al visualizar datos georeferenciados o mapas coropléticos (con colores en las zonas geográficas que se corresponden con los datos) yace en que usamos mapas que tienen geometrías o características geográficas mucho más detalladas de lo que necesitamos.

Esto puede deberse a uqe obtenemos mapas desde Shapes u otras fuentes cuyo objetivo es representar fidedignamente los territorios; pero al visualizar datos generalmente producimos visualizaciones que no necesitan exactitud milimétrica en sus polígonos. 

El problema de trabajar con mapas muy detallados es que la velocidad con la que se generan se ve impactada debido al detalle, lo que resulta inconveniente dado que al visualizar datos usualmente nos encontramos iterando decenas de veces una misma visualización hasta que se vea como queremos. 
...
```
Según la prueba, el mapa simplificado se genera 2.4 veces más rápido.
...
El mapa simplificado consume un 1% de memoria con respecto al mapa original.
